...
<nav class="bg-white border border-gray-200 dark:border-gray-700 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-800 shadow">
  <div class="container flex flex-wrap justify-between items-center mx-auto">
    <a href="index.php" class="flex items-center">
      ...
      PEMILIHAN MAHASISWA BERPRESTASI FT UNSOED
      </span>
    </a>
    ...
    >
      <ul class="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
        <li>
            <a
            href="./index.php"
            class="block py-2 pr-4 pl-3 text-black rounded md:bg-transparent md:text-gray-700 md:p-0 dark:text-white md:hover:bg-transparent md:border-0 md:hover:text-blue-700"
            aria-current="page"
            >
            Dashboard
          </a>
